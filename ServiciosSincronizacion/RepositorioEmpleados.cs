...
namespace ServiciosSincronizacion
{
    public class RepositorioEmpleados
    {
        ...
        public DataTable ObtenerDatosEmpleadosBjada(Empleados empleados)
        {
            DataTable tabla = new DataTable();
            SqlConnection sqlCon = new SqlConnection();
            SqlDataReader resultado;
        ...
        public DataTable ValidarEmpleadoSincronizacionBajada(Empleados empleados)
        {
            DataTable tabla = new DataTable();
            SqlConnection sqlCon = new SqlConnection();
            SqlDataReader resultado;
        ...
        public string ActualizarDatosEmpleadoBajada(Empleados empleados)
        {
            string rta = "";
            SqlConnection sqlCon = new SqlConnection();
            try
        ...
        public string ActualizarEstadoEmpleadosSincronizacionBajada(Empleados empleados)
        {
            string rta = "";
            SqlConnection sqlCon = new SqlConnection();
            try
        ...
        public string RegistrarEmpleadoSincronizacionBajada(Empleados empleados)
        {
            string rta = "";
            SqlConnection sqlCon = new SqlConnection();
            try
