...
namespace ServiciosSincronizacion
{
    public class RepositorioAsistencias
    {
        ...
        public DataTable ObtenerAsistenciasSincronizacionBajada(Asistencias asistencias)
        {
            DataTable tabla = new DataTable();
            SqlConnection sqlCon = new SqlConnection();
            SqlDataReader resultado;
        ...
        public DataTable ValidarAsistenciaSincronizacionBajada(Asistencias asistencias)
        {
            DataTable tabla = new DataTable();
            SqlConnection sqlCon = new SqlConnection();
            SqlDataReader resultado;
        ...
        public string ActualizarEstadoAsistenciaSincronizacionBajada(Asistencias asistencias)
        {
            string rta = "";
            SqlConnection sqlCon = new SqlConnection();
            try
        ...
        public string ActualizaAsistenciaSalidaSincronizacionBajada(Asistencias asistencias)
        {
            string rta = "";
            SqlConnection sqlCon = new SqlConnection();
            try
        ...
        public string RegistrarAsistenciaSincronizacionBajada(Asistencias asistencias)
        {
            string rta = "";
            SqlConnection sqlCon = new SqlConnection();
            try
