...
namespace ServiciosSincronizacion
{
    public class RepositorioExtras
    {
        ...
        public DataTable ObtenerExtrasSincronizacionBajada(HorasExtras horasExtras)
        {
            DataTable tabla = new DataTable();
            SqlConnection sqlCon = new SqlConnection();
            SqlDataReader resultado;
        ...
        public DataTable ValidarExtrasSincronizacionBajada(HorasExtras horasExtras)
        {
            DataTable tabla = new DataTable();
            SqlConnection sqlCon = new SqlConnection();
            SqlDataReader resultado;
        ...
        public string ActualizarEstadoExtraSincronizacionBajada(HorasExtras horasExtras)
        {
            string rta = "";
            SqlConnection sqlCon = new SqlConnection();
            try
        ...
        public string RegistrarHorasExtrasSincronizacionBajada(HorasExtras horasExtras)
        {
            string rta = "";
            SqlConnection sqlCon = new SqlConnection();
            try
